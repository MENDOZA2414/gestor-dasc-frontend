  ...
  return (
    <Layout user={user} userType={userType}>
      <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
        ...
        {/* Totales */}
        <Card className="col-span-3 h-24">
        ...
        {/* Resto de cards */}
        <Card title="Actividad reciente" className="col-span-6 h-64" />
        <Card title="Alumnos por entidad" className="col-span-3 h-64" />
        <Card title="Prácticas activas / concluidas" className="col-span-3 h-64" />
        <Card title="Actividad reciente" className="col-span-9 h-64" />
        <Card title="Reportes generados" className="col-span-3 h-64" />
      </div>
    </Layout>
  );
};
