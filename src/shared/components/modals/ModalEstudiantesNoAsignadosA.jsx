...
import { getAllStudents, reassignInternalAssessor } from '@modules/admin/services/studentsService';
 ...
 */
const ModalEstudiantesNoAsignadosA = ({ isOpen, onClose, internalAssessorID }) => {
      ...
      render: (row) => {
        ...
        return (
          <div className="flex gap-2 justify-center">
            <IconButton icon="add" title="Asignar Estudiante"
              onClick={() => reassignInternalAssessor(row.matricula, internalAssessorID)} />
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title={'Estudiantes sin asignar a ' + internalAssessor.firstName + ' ' + internalAssessor.firstLastName + ' ' + internalAssessor.secondLastName + ' '} >
...
export default ModalEstudiantesNoAsignadosA